...
pipeline = Pipeline(
    steps=[
        LoadDataFrameFromPickleStep(path="/home/tomifernandezlabo3/gcs-bucket/experiments/exp_lgbm_target_delta_20250708_0105/df_procesamiento_1.pkl"), ## Cambiar por el path correcto del pickle
